...
{
    [FormerlySerializedAs("quickSettingsDropdown")] [SerializeField]
    private TMP_Dropdown _quickSettingsDropdown;
    [FormerlySerializedAs("activeExperimentDropdown")] [SerializeField]
    private TMP_Dropdown _activeExperimentDropdown;
